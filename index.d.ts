...
declare global
{
    ...
    {
        getAllEnemyCreep(): List<Creep>;
        getAllMyCreep(): List<Creep>;
        getAllWoundedCreep(): List<Creep>;
        getAdjacentPosition(direction: number): RoomPosition;
        checkForRampart() : List<Rampart>;
    }
    ...
    interface UnderscoreWrappedObject
    {
        ...
        each(iterator: UnderscoreVoidListIterator,
             context?: any): UnderscoreWrappedObject;
        each(iterator: UnderscoreVoidObjectIterator,
             context?: any): UnderscoreWrappedObject;
        forEach(iterator: UnderscoreVoidListIterator,
                context?: any): UnderscoreWrappedObject;
        forEach(iterator: UnderscoreVoidObjectIterator,
                context?: any): UnderscoreWrappedObject;

        map(iterator: UnderscoreListIterator,
            context?: any): UnderscoreWrappedObject;
        map(iterator: UnderscoreObjectIterator,
            context?: any): UnderscoreWrappedObject;
        collect(iterator: UnderscoreListIterator,
                context?: any): UnderscoreWrappedObject;
        collect(iterator: UnderscoreObjectIterator,
                context?: any): UnderscoreWrappedObject;

        reduce(iterator: UnderscoreMemoListIterator,
               memo: any,
               context?: any): UnderscoreWrappedObject;
        reduce(iterator: UnderscoreMemoObjectIterator,
               memo: any,
               context?: any): UnderscoreWrappedObject;
        inject(iterator: UnderscoreMemoListIterator,
               memo: any,
               context?: any): UnderscoreWrappedObject;
        inject(iterator: UnderscoreMemoObjectIterator,
               memo: any,
               context?: any): UnderscoreWrappedObject;
        foldl(iterator: UnderscoreMemoListIterator,
              memo: any,
              context?: any): UnderscoreWrappedObject;
        foldl(iterator: UnderscoreMemoObjectIterator,
              memo: any,
              context?: any): UnderscoreWrappedObject;

        reduceRight(iterator: UnderscoreMemoListIterator,
                    memo: any,
                    context?: any): UnderscoreWrappedObject;
        reduceRight(iterator: UnderscoreMemoObjectIterator,
                    memo: any,
                    context?: any): UnderscoreWrappedObject;
        foldr(iterator: UnderscoreMemoListIterator,
              memo: any,
              context?: any): UnderscoreWrappedObject;
        foldr(iterator: UnderscoreMemoObjectIterator,
              memo: any,
              context?: any): UnderscoreWrappedObject;

        find(predicate: UnderscorePredicate,
             context?: any): UnderscoreWrappedObject;
        detect(predicate: UnderscorePredicate,
               context?: any): UnderscoreWrappedObject;

        filter(predicate: UnderscorePredicate,
               context?: any): UnderscoreWrappedObject;
        select(predicate: UnderscorePredicate,
               context?: any): UnderscoreWrappedObject;

        where(properties: any): UnderscoreWrappedObject;

        reject(predicate: UnderscorePredicate,
               context?: any): UnderscoreWrappedObject;

        all(predicate: UnderscorePredicate,
            context?: any): UnderscoreWrappedObject;
        every(predicate: UnderscorePredicate,
              context?: any): UnderscoreWrappedObject;

        any(predicate?: UnderscorePredicate,
            context?: any): UnderscoreWrappedObject;
        some(predicate?: UnderscorePredicate,
             context?: any): UnderscoreWrappedObject;
        ...
        invoke(methodName: string,
               ...arguments: any[]): UnderscoreWrappedObject;

        pluck(propertyName: string): UnderscoreWrappedObject;

        max(iterator?: UnderscoreIterator,
            context?: any): UnderscoreWrappedObject;

        min(iterator?: UnderscoreIterator,
            context?: any): UnderscoreWrappedObject;

        sortBy(property?: string,
               context?: any): UnderscoreWrappedObject;
        sortBy(iterator?: UnderscoreIterator,
               context?: any): UnderscoreWrappedObject;
        ...
        uniq(isSorted?: boolean,
             UnderscoreIterator?: UnderscoreIterator): UnderscoreWrappedObject;
        unique(isSorted?: boolean,
               UnderscoreIterator?: UnderscoreIterator): UnderscoreWrappedObject;
        ...
        indexOf(value: any,
                isSorted?: boolean): UnderscoreWrappedObject;

        lastIndexOf(value: any,
                    fromIndex?: number): UnderscoreWrappedObject;

        sortedIndex(value: any,
                    UnderscoreIterator?: UnderscoreIterator): UnderscoreWrappedObject;
        ...
        debounce(wait: number,
                 immediate?: boolean): UnderscoreWrappedObject;
        ...
        template(data?: any,
                 settings?: any): (...as: any[]) => UnderscoreWrappedObject;
    ...
    interface UnderscoreOOStatic
    {
        ...
        uniq(isSorted?: boolean,
             UnderscoreIterator?: UnderscoreIterator): any[];
        unique(isSorted?: boolean,
               UnderscoreIterator?: UnderscoreIterator): any[];
        ...
        template(data?: any,
                 settings?: UnderscoreTemplateSettings): (...as: any[]) => string;
    ...
    interface UnderscoreStatic
    {
        ...
        // Collection Functions (Arrays or Objects)
        each(list: any[],
             iterator: UnderscoreVoidListIterator,
             context?: any): void;
        each(object: any,
             iterator: UnderscoreVoidObjectIterator,
             context?: any): void;
        forEach(list: any[],
                iterator: UnderscoreVoidListIterator,
                context?: any): void;
        ...
        map(list: any[],
            iterator: UnderscoreListIterator,
            context?: any): any[];
        map(object: any,
            iterator: UnderscoreObjectIterator,
            context?: any): any[];
        collect(list: any[],
                iterator: UnderscoreListIterator,
                context?: any): any[];
        ...
        reduce(list: any[],
               iterator: UnderscoreMemoListIterator,
               memo: any,
               context?: any): any;
        reduce(list: any,
               iterator: UnderscoreMemoObjectIterator,
               memo: any,
               context?: any): any;
        inject(list: any[],
               iterator: UnderscoreMemoListIterator,
        ...
        max(list: any,
            UnderscoreIterator?: UnderscoreIterator,
            context?: any): any;
        ...
        groupBy(list: any,
                property: string): any;
        groupBy(list: any,
                iterator: UnderscoreIterator): any;
        ...
        memoize(fn: (...args: any[]) => any,
                hashFunction?: (value: any) => any): (...args: any[]) => any;

        delay(fn: (...args: any[]) => any,
              wait: number,
              ...arguments: any[]): void;

        defer(fn: (...args: any[]) => any,
              ...arguments: any[]): void;

        throttle(fn: (...args: any[]) => any,
                 wait: number): (...args: any[]) => any;
        ...
        wrap(fn: (...args: any[]) => any,
             wrapper: (...args: any[]) => any): (...args: any[]) => any;
        ...
        sum(creeps: { [p: string]: any },
            param2: (x) => boolean): any;
    }
